...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("RefrigeratorCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("RefrigeratorCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("RefrigeratorCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "RefrigeratorCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"dnsseed.refrigeratorcoin.com", "dnsseed.refrigeratorcoin.com"}, //Main RefrigeratorCoin Seed Node
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("RefrigeratorCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("RefrigeratorCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("RefrigeratorCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("RefrigeratorCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RefrigeratorCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("RefrigeratorCoin-start");
