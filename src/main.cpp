...
const string strMessageMagic = "RefrigeratorCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RefrigeratorCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "RefrigeratorCoin - Im not Chinese !";
        CTransaction txNew;
        txNew.nTime = 1405875873;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1405875873;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2660213;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
	...
	printf("Generating new genesis block...\n");
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x0e888d162d45796ee31fa3fc923c889127e5b6143b390476e34cabcfe2265a87"));
        block.print();
